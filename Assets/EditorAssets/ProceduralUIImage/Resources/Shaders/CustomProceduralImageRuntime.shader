Shader "UI/Custom Procedural UI Image"
{
	Properties
    {
    	...
    	_GradientType("GradientType", Range(0,2)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f IN) : SV_Target
			{
				...
				half dist =  distance(v,l);
				color = lerp(_Color1, _Color2, (dist) ) * color;
				color.a *= saturate((l-dist)*IN.pixelWorldScale);
